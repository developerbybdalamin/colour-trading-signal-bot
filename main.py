...
# 🧠 তোমার নতুন বট টোকেন বসাও নিচে 👇
bot = telebot.TeleBot("8531032291:AAGYofpOgXdbJI3W7jLErRZkiNxgpJzUP8k")

# 👑 OWNER SYSTEM - শুধুমাত্র Owner ব্যবহার করতে পারবে
OWNER_ID = 8473134685  # 🔥 তোমার টেলিগ্রাম User ID এখানে বসাও
...
# 🔄 বট চালু করো
print("🤖 HGZY DUAL API Advanced Auto Prediction Bot is running...")
print("🔗 API 1:", CURRENT_API)
print("🔗 API 2:", HISTORY_API)
print("🎯 Features: Unlimited Prediction + 20-Minute Timed Prediction")
print("📊 Win/Loss Tracking System: Active")
print("🎭 Multi-Channel System: UNLIMITED CHANNEL SUPPORT")
print("💸 NEW PREDICTION MESSAGE DESIGN: ACTIVE (Confidence Removed)")
print("🔇 SILENT MODE: No User Notifications for Predictions/Win-Loss")
print("🔧 New Design: 3-Button System with Pagination")
print("🎯 NEW: Season Start/Off Sticker System")
print("⏰ Season Off Logic: Sends Win/Loss FIRST, then Season Off in next period")
print("🔒 NEW: Private Channel Support with Chat ID")
print("🎲 NEW: Rule-Based Prediction System (Prompt API) - Integrated")
print("👑 OWNER SYSTEM: ACTIVE - Only Owner Can Use")
